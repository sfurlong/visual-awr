...
public class IOStatStorageCellTimeSeriesChart extends RootChartFrame {

    private BorderLayout borderLayout = new BorderLayout();
    private int _totalNumRacInstances = 2;

    public IOStatStorageCellTimeSeriesChart() {

    }

    public IOStatStorageCellTimeSeriesChart(String metricName, String chartHeaderText) {
