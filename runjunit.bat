...
set CLASSPATH=%APP_HOME%\lib\hamcrest-junit-2.0.0.0.jar;%CLASSPATH%
set CLASSPATH=%APP_HOME%\lib\java-hamcrest-2.0.0.0.jar;%CLASSPATH%



set path=%JAVA_HOME%\bin;%path%

java %JAVA_OPTS% -DAPP_HOME=%APP_HOME% org.junit.runner.JUnitCore org.altaprise.test.TestDemoFilesAndCharts > junit.out 2>&1
